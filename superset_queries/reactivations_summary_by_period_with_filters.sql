...
-- С ПОДДЕРЖКОЙ ФИЛЬТРОВ DASHBOARD
-- 
-- ИНСТРУКЦИЯ ПО НАСТРОЙКЕ:
-- 1. Создайте Chart на основе этого запроса
-- 2. В SQL Lab нажмите "Query Settings" (шестеренка справа)
-- 3. В разделе "Parameters" добавьте:
--    - start_date (Type: Date, Default: 2025-11-01)
--    - end_date (Type: Date, Default: 2025-11-30)
-- 4. Сохраните Chart
-- 5. На Dashboard добавьте фильтр "Date Range Filter"
-- 6. Настройте Scoping, чтобы фильтр применялся к Chart
--
-- Визуализации:
